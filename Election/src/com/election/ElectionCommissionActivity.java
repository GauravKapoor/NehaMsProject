...
public class ElectionCommissionActivity extends Activity {
	/** Called when the activity is first created. */
	Button sub;
	EditText VName, VUid, VDOB, VArea;

	@Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.sdsms);
        sub = (Button)findViewById(R.id.submit) ;
        VName=(EditText)findViewById(R.id.vname);
        VUid=(EditText)findViewById(R.id.vuid);
        VDOB=(EditText)findViewById(R.id.vdob);
        VArea=(EditText)findViewById(R.id.varea);
        sub.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				String voterarea = VArea.getText().toString();
				
				String smsmessage = "REGISTER#uname:"+votername+"#uid:"+voteruid+"#dob:"+voterdob+"#area:"+voterarea;
	...
	public void sendSMS(String message) {
		...
		try {
			byte[] req_data = TripleDES.encrypt(message);
